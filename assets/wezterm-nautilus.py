...
class OpenInWezTermAction(GObject.GObject, Nautilus.MenuProvider):
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in OrcaTerm',
            icon='org.sianbox.orcaterm')
