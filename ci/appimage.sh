...
install -Dm644 assets/icon/terminal.png AppDir/usr/share/icons/hicolor/128x128/apps/org.sianbox.orcaterm.png
install -Dm644 assets/wezterm.desktop AppDir/usr/share/applications/org.sianbox.orcaterm.desktop
install -Dm644 assets/wezterm.appdata.xml AppDir/usr/share/metainfo/org.sianbox.orcaterm.appdata.xml
